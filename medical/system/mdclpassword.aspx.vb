...
Partial Class mdclpassword 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDCLPASS" 
...
#Region " イベント "
    ...
    '変更ボタン押下処理 
    Protected Sub btnRun_ServerClick(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) 
    ...
    'クリアボタン押下処理 
    Protected Sub btnClear_ServerClick(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) 
        DisplayClear() 
    End Sub 
    ...
    Protected Sub btnBack_ServerClick(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) 
        Session("login") = False 
        Response.Redirect("mdcllogin.aspx", False) 
    End Sub 
...
#Region " チェック関連 " 
    ...
    '旧パスワードチェック 
    Protected Sub valPassOld2_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) 
    ...
    '新パスワードチェック 
    Protected Sub valPassNew1b_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) 
        If txtPassOld.Text.Trim.Equals("") Then Return 
        args.IsValid = txtPassOld.Text.Trim() <> txtPassNew1.Text.Trim() 
    End Sub 
 
    '新パスワード(確認用)チェック 
    Protected Sub valPassNew2b_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) 
