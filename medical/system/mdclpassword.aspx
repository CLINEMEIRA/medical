<%@ Page Language="VB" AutoEventWireup="true" Inherits="medical.mdclpassword" Codebehind="mdclpassword.aspx.vb" %> 
            ...
            <table cellspacing="1" cellpadding="2" bgcolor="#f7f7f7" border="0"> 
              ...
              <tr> 
                ...
                <td bgcolor="#d9ffcc" align="left"> 
                  ...
                  <asp:CustomValidator id="valPassOld2" runat="server" Display="Dynamic" ControlToValidate="txtPassOld" ErrorMessage="パスワードが間違っています" OnServerValidate="valPassOld2_ServerValidate" EnableClientScript="False" ValidationGroup="run" /> 
                </td> 
              </tr> 
              <tr> 
                <!-- 新パスワード --> 
                ...
                <td bgcolor="#d9ffcc" align="left"> 
                  ...
                  <asp:CustomValidator id="valPassNew1b" runat="server" Display="Dynamic" ControlToValidate="txtPassNew1" ErrorMessage="パスワードは必ず変更して下さい" OnServerValidate="valPassNew1b_ServerValidate" EnableClientScript="False" ValidationGroup="run" /> 
                </td> 
              </tr> 
              <tr> 
                <!-- 新パスワード(確認用) --> 
                ...
                <td bgcolor="#d9ffcc" align="left"> 
                  ...
                  <asp:CustomValidator id="valPassNew2b" runat="server" Display="Dynamic" ControlToValidate="txtPassNew2" ErrorMessage="新パスワードと一致しません" OnServerValidate="valPassNew2b_ServerValidate" EnableClientScript="False" ValidationGroup="run" /> 
                </td> 
              </tr> 
              <tr> 
                <td align="center" bgcolor="#f7f7f7"></td> 
                <td bgcolor="#f7f7f7" align="left"> 
                  <input id="btnRun" type="image" src="../image/b_change.gif" runat="server" onserverclick="btnRun_ServerClick" /> 
                  <input id="btnClear" type="image" src="../image/b_clear.gif" runat="server" onserverclick="btnClear_ServerClick" causesvalidation="false" /> 
                  <input id="btnBack" type="image" src="../image/b_back.gif" runat="server" onserverclick="btnBack_ServerClick" causesvalidation="false" /> 
                </td> 
              </tr> 
            </table> 
          </ContentTemplate> 
