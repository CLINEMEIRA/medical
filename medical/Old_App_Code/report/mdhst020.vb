...
#Region "ActiveReports Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(mdhst020))
        ...
        'Detail
        '
        Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtNyukoNo, Me.txtRenNo, Me.txtZairyoCode, Me.txtChumonNo, Me.txtNyukoMotoCode, Me.txtZairyoLotNo, Me.txtNyukoRyo, Me.txtNyukoDate, Me.TextBox})
        Me.Detail.Height = 0.2076389!
        Me.Detail.Name = "Detail"
        '
        'PageHeader
        '
        Me.PageHeader.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.Label, Me.lblDate, Me.Label12, Me.lblPage, Me.Shape, Me.Line, Me.Label1, Me.Label2, Me.Label3, Me.Label4, Me.Label5, Me.Label6, Me.Label7, Me.Label8, Me.Label9, Me.lblMonth, Me.Label10})
        ...
        Me.Label2.Width = 0.4000001!
        '
        'Label3
        '
        Me.Label3.Height = 0.2!
        Me.Label3.HyperLink = Nothing
        Me.Label3.Left = 1.266667!
        ...
        Me.Label10.Left = 3.466667!
        Me.Label10.Name = "Label10"
        Me.Label10.Style = "font-family: ＭＳ ゴシック; font-size: 9.75pt; text-align: left; vertical-align: bottom" & _
            ""
        Me.Label10.Text = "部品番号"
        Me.Label10.Top = 0.7333333!
        Me.Label10.Width = 0.5999997!
        '
        'txtNyukoNo
        '
        Me.txtNyukoNo.DataField = "SHIP_NO"
        ...
        Me.txtZairyoCode.Left = 1.266667!
        ...
        'txtChumonNo
        '
        Me.txtChumonNo.DataField = "COMPANY_NO"
        Me.txtChumonNo.Height = 0.2!
        Me.txtChumonNo.Left = 2.4!
        Me.txtChumonNo.Name = "txtChumonNo"
        Me.txtChumonNo.Style = "font-family: ＭＳ ゴシック; font-size: 9.75pt; vertical-align: bottom"
        Me.txtChumonNo.Text = "XXXXXX"
        Me.txtChumonNo.Top = 0!
        Me.txtChumonNo.Width = 0.4666668!
        '
        'txtNyukoMotoCode
        '
        Me.txtNyukoMotoCode.DataField = "INDICATE_NO"
        Me.txtNyukoMotoCode.Height = 0.2!
        Me.txtNyukoMotoCode.Left = 2.933334!
        ...
        Me.txtNyukoMotoCode.Text = "XXXXX"
        Me.txtNyukoMotoCode.Top = 0!
        Me.txtNyukoMotoCode.Width = 0.3999999!
        '
        'txtZairyoLotNo
        '
        Me.txtZairyoLotNo.DataField = "LOT_NO"
        Me.txtZairyoLotNo.Height = 0.2!
        Me.txtZairyoLotNo.Left = 4.866667!
        ...
        'txtNyukoRyo
        '
        Me.txtNyukoRyo.DataField = "SHIP_WAT"
        Me.txtNyukoRyo.Height = 0.2!
        Me.txtNyukoRyo.Left = 5.533333!
        ...
        'txtNyukoDate
        '
        Me.txtNyukoDate.DataField = "SHIP_DT"
        Me.txtNyukoDate.Height = 0.2!
        Me.txtNyukoDate.Left = 6.533333!
        ...
        Me.lblLast1.Style = "font-family: ＭＳ ゴシック; font-size: 9.75pt; text-align: center; vertical-align: bott" & _
            "om"
        Me.lblLast1.Text = "出庫日が抽出範囲ではないもの"
        ...
        OleDBDataSource1.ConnectionString = "Provider=MSDAORA.1;Password=medical;User ID=medical;Data Source=medical;Persist S" & _
            "ecurity Info=True"
        OleDBDataSource1.SQL = "SELECT SHIP_NO,REN_NO,MATL_CD,COMPANY_NO,INDICATE_NO,CATALOG_NO,LOT_NO,SHIP_WAT,S" & _
            "HIP_DT" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM MATL_SHIP_TBL" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER BY SHIP_NO,REN_NO"
...
#End Region
    ...
    Private Sub mdhst020_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PageStart
        _nPage += 1
    End Sub

    Private Sub mdhst020_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportEnd
    End Sub

    Private Sub mdhst020_DataInitialize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.DataInitialize
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        Fields("NyukoDate").Value = DateFormat(GetString(Fields("SHIP_DT").Value))
    End Sub
