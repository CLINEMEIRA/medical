<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc011" Codebehind="mdsrc011.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(catalog,zumen) 
    { 
        if(zumen == "&nbsp;") zumen = ""; 
        parent.window.returnValue = catalog + "," + zumen + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
      ...
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            ...
            <td width="300" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCatalog" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="17" Width="130px"></asp:TextBox> 
              <asp:Button ID="btnSearch" runat="server" Text="" style="display:none"/> 
            </td> 
          </tr> 
          <tr> 
            <td align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>元カタログ番号</b></font></td> 
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtMoto" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="20" Width="160px"></asp:TextBox> 
            </td> 
          </tr> 
          <tr> 
            <td align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>社内NO</b></font></td> 
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtSyanai" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="6" Width="50px"></asp:TextBox> 
            </td> 
          </tr> 
        </table> 
      </td> 
          ...
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                ...
                <asp:BoundColumn  HeaderText="元カタログ番号" SortExpression="O_CATALOG_NO" DataField="O_CATALOG_NO" > 
                    <ItemStyle Width="120px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="120px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn  HeaderText="図面管理番号" SortExpression="WORK_STD_NO" DataField="WORK_STD_NO" > 
                    <ItemStyle Width="120px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="120px" /> 
                </asp:BoundColumn> 
