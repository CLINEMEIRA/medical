...
Partial Class mdsrc230 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC230" 
    Private Const PROGRAM_TITLE As String = "プログラム検索" 
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                txtCode.Text = Request.QueryString("pid").Trim()
                txtName.Text = Request.QueryString("pname").Trim()
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            ...
            sQuery += "WHERE MENU_LEBEL = '2' AND SUBSTR(PROGRAM_ID,1,:K10) >= :K11 AND PG_NM LIKE :K01"
