<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc010" Codebehind="mdsrc010.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(catalog,syanai,kumi) 
    { 
        if(syanai == "&nbsp;") syanai = ""; 
        if(kumi   == "&nbsp;") kumi   = ""; 
        parent.window.returnValue = catalog + "," + syanai + "," + kumi + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
      ...
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            ...
            <td width="330" align="left" bgcolor="#FFE7DF"> 
