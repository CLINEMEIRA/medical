...
Partial Class master_mdsrc122 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC122" 
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            ...
            sQuery += "WHERE WH_END_FLG ='0' AND WH_END_DT = '00000000' AND TRIM(CANCEL_CD) IS NULL AND OF_OUT_FLG = '1' AND "
