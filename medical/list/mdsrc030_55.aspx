<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc030_55" Codebehind="mdsrc030_55.aspx.vb" %> 
        ...
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            ...
            <td width="240" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtShop" runat="server" onfocus="moveCursorLast(this);" MaxLength="2" Width="20px" Visible ="false"></asp:TextBox> 
          ...
          <tr> 
            ...
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCode" runat="server" onfocus="moveCursorLast(this);" MaxLength="4" Width="40px"></asp:TextBox>
            </td> 
          </tr> 
          <tr>
            <td align="center"></td>
