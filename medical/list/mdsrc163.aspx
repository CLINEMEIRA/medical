<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc163" Codebehind="mdsrc163.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(catalog,lotno) 
    { 
        if(lotno == "&nbsp;") lotno = ""; 
        parent.window.returnValue = catalog + "," + lotno + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
      ...
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            ...
            <td width="350" align="left" bgcolor="#FFE7DF"> 
          ...
          <tr> 
            <td width="100" align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>ロットNO</b></font></td> 
            <td width="350" align="left" bgcolor="#FFE7DF"> 
          ...
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                ...
                <asp:BoundColumn HeaderText="ロットNO" SortExpression="INDICATE_NO" DataField="INDICATE_NO" > 
