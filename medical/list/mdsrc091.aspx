<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc091" Codebehind="mdsrc091.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(siji,syanaino,kumi,catalog,sikakari) 
    { 
        parent.window.returnValue = siji + "," + syanaino + "," + kumi + "," + catalog + "," + sikakari + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
      ...
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            ...
            <td width="185" align="left" bgcolor="#FFE7DF"> 
          ...
          <tr> 
            ...
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtShanai" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="17" Width="60px"></asp:TextBox>
            </td> 
          </tr> 
        </table> 
      </td> 
          ...
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                ...
                <asp:BoundColumn DataField="C_NO" HeaderText="組番" SortExpression="C_NO"> 
                ...
                <asp:BoundColumn  HeaderText="現仕掛数" SortExpression="PW_AMT" DataField="PW_AMT" Visible="false"> 
                </asp:BoundColumn> 
              </Columns> 
