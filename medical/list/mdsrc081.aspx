<%@ Page Language="VB" AutoEventWireup="false" Inherits="master_mdsrc081" Codebehind="mdsrc081.aspx.vb" %> 
          ...
          <tr> 
            ...
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCode" runat="server" 
                    onkeyup="document.getElementById('btnSearch').click();" 
                    onfocus="moveCursorLast(this);" MaxLength="10" Width="81px">1234567890</asp:TextBox> 
