<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc170" Codebehind="mdsrc170.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(syanai,sijino,koujun,koutei,catalog,catalog2) 
    { 
        parent.window.returnValue = syanai + "," + sijino + "," + koujun + "," + koutei + "," + catalog + "," + catalog2 + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
      ...
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr height="20"> 
            ...
            <td width="784" align="left" bgcolor="#FFE7DF"> 
          ...
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                ...
                <asp:BoundColumn HeaderText="カタログ番号" DataField="I_PARTS_NO" SortExpression="I_PARTS_NO"> 
                  <ItemStyle Width="140px" HorizontalAlign="Left" /> 
                  <HeaderStyle Width="140px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="必要数" DataField="COMP_NEED_AMT" SortExpression="COMP_NEED_AMT" DataFormatString="{0:###,###,##0}"> 
                  <ItemStyle Width="70px" HorizontalAlign="Right"/> 
                  <HeaderStyle Width="70px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="着工数" DataField="STW_AMT" SortExpression="STW_AMT" DataFormatString="{0:###,###,##0}"> 
                  <ItemStyle Width="70px" HorizontalAlign="Right"/> 
                  <HeaderStyle Width="70px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="仕掛数" DataField="PW_AMT" SortExpression="PW_AMT" DataFormatString="{0:###,###,##0}"> 
                  <ItemStyle Width="70px" HorizontalAlign="Right"/> 
                  <HeaderStyle Width="70px" /> 
                </asp:BoundColumn> 
                <asp:TemplateColumn HeaderText="納期" SortExpression="DELIVERY_DT" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Center"> 
                  <ItemTemplate> 
                ...
                <asp:BoundColumn  HeaderText="工順" DataField="PROCESS_ORDER" SortExpression="PROCESS_ORDER"> 
                  <ItemStyle Width="60px" HorizontalAlign="Left"/> 
                  <HeaderStyle Width="60px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="工程名称" DataField="P_ORDER_NM" SortExpression="P_ORDER_NM"> 
                  <ItemStyle Width="140px" HorizontalAlign="Left" /> 
                  <HeaderStyle Width="140px" /> 
                </asp:BoundColumn> 
                <asp:TemplateColumn  HeaderText="完了" SortExpression="RESULTS_DT" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Center"> 
                  <ItemTemplate> 
                    <asp:Label ID="Label1" runat="server" Text='<%#MedicalLib.Common.DateFormat(DataBinder.Eval(Container, "DataItem.RESULTS_DT"))%>'></asp:Label> 
                  </ItemTemplate> 
                  <HeaderStyle Width="90px" /> 
                </asp:TemplateColumn> 
                <asp:BoundColumn DataField="対象PROCESS_ORDER" Visible="false"> 
                  <ItemStyle Width="10px" HorizontalAlign="Left"/> 
                </asp:BoundColumn> 
                <asp:BoundColumn DataField="対象P_ORDER_NM" Visible="false"> 
                  <ItemStyle Width="10px" HorizontalAlign="Left" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn DataField="M_PARTS_NO" Visible="false"> 
                  <ItemStyle Width="10px" HorizontalAlign="Left" /> 
                </asp:BoundColumn> 
              </Columns> 
