<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc030" Codebehind="mdsrc030.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(code,name,rname) 
    { 
        if(rname == "&nbsp;") rname = ""; 
        parent.window.returnValue = code + "," + name + "," + rname + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
    ...
    <tr> 
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            <td width="100" align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>SHOP</b></font></td> 
            <td width="240" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtShop" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="2" Width="20px" Visible="False"></asp:TextBox> 
              <asp:DropDownList ID="ddlShop" runat="server" onChange="document.getElementById('btnSearch').click();" ></asp:DropDownList>
              <asp:Button ID="btnSearch" runat="server" Text="" style="display:none"/> 
            </td>
          </tr> 
          <tr>
            <td align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>作業者コード</b></font></td> 
        ...
        <asp:UpdatePanel ID="udpList" runat="server" UpdateMode="Conditional" > 
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                <asp:BoundColumn  HeaderText="コード" SortExpression="WORKER_CD" DataField="WORKER_CD" > 
                    <ItemStyle Width="60px" HorizontalAlign="Center" /> 
                    <HeaderStyle Width="60px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="氏名" SortExpression="WORKER_NM" DataField="WORKER_NM" > 
                    <ItemStyle Width="150px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="150px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="略称" SortExpression="WORKER_ABB" DataField="WORKER_ABB" > 
