...
Partial Class master_mdsrc050 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC050" 
    Private Const PROGRAM_TITLE As String = "SHOPコード検索" 
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                txtCode.Text = Request.QueryString("shop").Trim()
                MedicalLib.Common.ListSort = "SHOP"
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT A.SHOP,A.SHOP_NM,B.ITEM_NM,A.ORGANIZE_CD "
            sQuery += "FROM SHOP_MST A,(SELECT TELL_CD,ITEM_NM FROM GENERAL_PURPOSE_TBL WHERE INFO_KB = 'MS019') B "
            sQuery += "WHERE A.ORGANIZE_CD = B.TELL_CD(+) AND SUBSTR(A.SHOP,1,:K10) >= :K11 "
            sQuery += "ORDER BY A.SHOP"
