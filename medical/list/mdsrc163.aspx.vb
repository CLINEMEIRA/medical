...
Partial Class master_mdsrc163 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC160" 
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                MedicalLib.Common.ListSort = "CATALOG_NO,INDICATE_NO"
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT A.CATALOG_NO,A.COMPANY_NO,B.INDICATE_NO,B.F_STOCK_AMT,B.LOT_NO "
            sQuery += "FROM PARTS_MST A,PARTS_STOCK_TBL B "
            sQuery += "WHERE A.COMPANY_NO = B.COMPANY_NO AND A.C_NO = 'Z9' AND B.F_STOCK_AMT > 0 AND "
            sQuery += "SUBSTR(A.CATALOG_NO,1,:K10) >= :K11 AND SUBSTR(B.INDICATE_NO,1,:K20) >= :K21 "
            sQuery += "ORDER BY A.CATALOG_NO,A.COMPANY_NO,B.INDICATE_NO"
