<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc080" Codebehind="mdsrc082.aspx.vb" %> 
    ...
    <tr> 
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr height="20"> 
            <td width="100" align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>情報区分</b></font></td> 
            <td width="290" align="left" bgcolor="#FFE7DF"><asp:Label ID="lblInfo" runat="server" Text="Label"></asp:Label></td> 
          <tr> 
            <td align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>識別コード</b></font></td> 
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCode" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="2" Width="20px"></asp:TextBox> 
        ...
        <asp:UpdatePanel ID="udpList" runat="server" UpdateMode="Conditional" > 
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                <asp:BoundColumn  HeaderText="識別C" SortExpression="TELL_CD" DataField="TELL_CD" > 
                    <ItemStyle Width="40px" HorizontalAlign="Center" /> 
                    <HeaderStyle Width="40px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="項目名" SortExpression="ITEM_NM" DataField="ITEM_NM"> 
                    <ItemStyle Width="340px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="340px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="項目名カナ" SortExpression="ITEM_KN" DataField="ITEM_KN"> 
                    <ItemStyle Width="340px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="340px" /> 
                </asp:BoundColumn> 
              </Columns> 
