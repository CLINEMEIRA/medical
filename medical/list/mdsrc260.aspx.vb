...
Partial Class master_mdsrc260
    Inherits System.Web.UI.Page 

    Private Const PROGRAM_ID As String = "MDSRC260" 
    Private Const PROGRAM_TITLE As String = "セット構成検索" 
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                txtCode.Text = Request.QueryString("setid").Trim()
                MedicalLib.Common.ListSort = "SET_ID"
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT SET_ID, MIN(SET_NAME) AS SET_NAME FROM SETCOMP_MST"
            sQuery += " WHERE SUBSTR(SET_ID,1,:K10) >= :K11"
            sQuery += " GROUP BY SET_ID ORDER BY SET_ID"
            _oHonsya.CreateParam("K10", GetKeyLength(txtCode.Text))
            _oHonsya.CreateParam("K11", GetKey(txtCode.Text))
            Dim oDataSet As DataSet = _oHonsya.CreateDataSetParam(sQuery, "TB1")
