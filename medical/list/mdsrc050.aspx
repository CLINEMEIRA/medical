<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc050" Codebehind="mdsrc050.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(code,name,sosiki) 
    { 
        parent.window.returnValue = code + "," + name + "," + sosiki + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
          ...
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                ...
                <asp:BoundColumn HeaderText="SHOP名称" SortExpression="SHOP_NM" DataField="SHOP_NM" > 
                    <ItemStyle Width="220px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="220px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn Visible=false DataField="ORGANIZE_CD" > 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="組織" SortExpression="ITEM_NM" DataField="ITEM_NM" > 
