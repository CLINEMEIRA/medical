<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc180" Codebehind="mdsrc180.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(Tyumon) 
    { 
        parent.window.returnValue = Tyumon; 
        parent.window.close(); 
    } 
    function closeWindow2(Tyumon,siji,shanai) 
    { 
        parent.window.returnValue = Tyumon + "," + siji + "," + shanai + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
    ...
    <tr> 
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            <td width="100" align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>注文NO</b></font></td> 
            <td width="150" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtTyumon" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="8" Width="80px"></asp:TextBox> 
        ...
        <asp:UpdatePanel ID="udpList" runat="server" UpdateMode="Conditional" > 
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                <asp:BoundColumn  HeaderText="注文NO" SortExpression="ORDER_NO" DataField="ORDER_NO" > 
                ...
                <asp:BoundColumn DataField="P_ORDER_FROM" HeaderText="工順" SortExpression="P_ORDER_FROM"> 
                    <ItemStyle Width="60px" HorizontalAlign="Center" /> 
                    <HeaderStyle Width="60px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn DataField="CONTRACTOUT_CD" HeaderText="外注コード" SortExpression="CONTRACTOUT_CD"> 
                    <ItemStyle Width="80px" HorizontalAlign="Center" /> 
                    <HeaderStyle Width="80px" /> 
                </asp:BoundColumn> 
              </Columns> 
