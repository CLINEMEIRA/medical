<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc040" Codebehind="mdsrc040.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(code,name,shop,scode,sname) 
    { 
        parent.window.returnValue = code + "," + name + "," + shop + "," + scode + "," + sname + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
    ...
    <tr> 
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            <td width="100" align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>工程コード</b></font></td> 
            <td width="405" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCode" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="5" Width="50px"></asp:TextBox> 
        ...
        <asp:UpdatePanel ID="udpList" runat="server" UpdateMode="Conditional" > 
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                <asp:BoundColumn  HeaderText="工程C" SortExpression="PROCESS_CD" DataField="PROCESS_CD" > 
                    <ItemStyle Width="60px" HorizontalAlign="Center" /> 
                    <HeaderStyle Width="60px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="工程名称" SortExpression="P_ORDER_NM" DataField="P_ORDER_NM" > 
                ...
                <asp:BoundColumn  DataField="FACILITIES_G_CD" Visible="false"> 
                    <ItemStyle Width="10px" HorizontalAlign="Center" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="設備" SortExpression="ITEM_NM" DataField="ITEM_NM" > 
                    <ItemStyle Width="200px" HorizontalAlign="Left" /> 
                    <HeaderStyle Width="200px" /> 
                </asp:BoundColumn> 
              </Columns> 
