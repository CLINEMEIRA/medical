...
Partial Class master_mdsrc100 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC100" 
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT LOT_NO,REN_NO,WH_DT,STOCK_WAT "
            sQuery += "FROM MATL_STOCK_TBL "
            sQuery += "WHERE MATL_CD = :K01 AND SUBSTR(LOT_NO,1,:K10) >= :K11 "
