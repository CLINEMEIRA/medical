<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc122" Codebehind="mdsrc122.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(chumon,code,renno) 
    { 
        parent.window.returnValue = chumon + "," + code + "," + renno + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
        ...
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            ...
            <td width="200" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCode" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="15" Width="150px"></asp:TextBox> 
          ...
          <tr> 
            ...
            <td width="200" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtNo" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="7" Width="70px"></asp:TextBox> 
            </td> 
          </tr> 
        </table> 
      </td> 
