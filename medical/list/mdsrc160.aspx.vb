...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT INDICATE_NO,COMPANY_NO,CATALOG_NO,F_STOCK_AMT,RSTOCK_AMT "
            sQuery += "FROM PARTS_STOCK_TBL "
            sQuery += "WHERE SUBSTR(CATALOG_NO,1,:K10) >= :K11 AND SUBSTR(INDICATE_NO,1,:K20) >= :K21 AND F_STOCK_AMT > 0 AND RSTOCK_AMT > 0 "
