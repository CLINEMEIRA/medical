...
Partial Class master_mdsrc071 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC071" 
    Private Const PROGRAM_TITLE As String = "外注コード検索" 
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                txtCode.Text = Request.QueryString("gaicyu").Trim()
                MedicalLib.Common.ListSort = "CONTRACTOUT_CD"
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT CONTRACTOUT_CD,CONTRACTOUT_NM,CONTRACTOUT_OMIS "
            sQuery += "FROM CONTRACTOUT_MST "
            sQuery += "WHERE SUBSTR(CONTRACTOUT_CD,1,:K10) >= :K11 AND CONTRACTOUT_KB = '1' "
            sQuery += "ORDER BY CONTRACTOUT_CD"
