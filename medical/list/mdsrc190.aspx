<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc190" Codebehind="mdsrc190.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(kihon,hojo) 
    { 
        parent.window.returnValue = kihon + "," + hojo + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
        ...
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr height="20"> 
            ...
            <td width="250" align="left" bgcolor="#FFE7DF"> 
              <asp:Label ID="lblSiji" runat="server"></asp:Label> 
            </td> 
          </tr> 
          <tr height="20"> 
            <td align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>社内NO</b></font></td> 
            <td align="left" bgcolor="#FFE7DF"> 
              <asp:Label ID="lblShanai" runat="server"></asp:Label> 
            </td> 
          </tr> 
          <tr height="20"> 
            <td align="center" bgcolor="#ff9966"><font color="#F7F7F7"><b>カタログ番号</b></font></td> 
            <td align="left" bgcolor="#ffe7df"> 
        ...
        <asp:UpdatePanel ID="udpList" runat="server" UpdateMode="Conditional" > 
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                <asp:TemplateColumn HeaderText="工順" SortExpression="PROCESS_ORDER" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Left"> 
                  <ItemTemplate> 
                ...
                <asp:BoundColumn  HeaderText="基本工順" DataField="P_ORDER_MAIN" Visible="false"> 
                    <ItemStyle Width="10px" HorizontalAlign="Center" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn  HeaderText="補助工順" DataField="P_ORDER_SUB" Visible="false"> 
                    <ItemStyle Width="10px" HorizontalAlign="Center" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="工程コード" SortExpression="PROCESS_CD" DataField="PROCESS_CD" > 
