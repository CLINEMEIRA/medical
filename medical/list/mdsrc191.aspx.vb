...
Partial Class master_mdsrc191 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC191" 
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        Try
            ...
            sQuery += "SELECT TO_CHAR(KS.P_ORDER_MAIN,'000') || '-' || TO_CHAR(KS.P_ORDER_SUB,'0') PROCESS_ORDER,KS.P_ORDER_MAIN,KS.P_ORDER_SUB,KS.PROCESS_CD,KM.P_ORDER_NM,KS.SHOP "
            sQuery += "FROM (SELECT * FROM INDICATE_TBL WHERE INDICATE_DECIDE_FLG = 'K' AND TRIM(DEL_FLG) IS NULL) S, "
            sQuery += "PROCESS_PROGRESS_TBL KS,PROCESS_MST KM "
            sQuery += "WHERE S.INDICATE_NO = :K01 "
            sQuery += "AND S.COMPANY_NO = :K02 "
            sQuery += "AND S.INDICATE_NO = KS.INDICATE_NO "
            sQuery += "AND S.COMPANY_NO = KS.COMPANY_NO "
            sQuery += "AND KS.PROCESS_CD = KM.PROCESS_CD"
