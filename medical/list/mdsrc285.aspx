<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc285" Codebehind="mdsrc285.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(setid,name) 
    { 
        parent.window.returnValue = setid + "," + name; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
    ...
    <tr> 
      <td width="100%" align="center"> 
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr> 
            <td width="100" align="center" bgcolor="#FF9966"><font color="#F7F7F7"><b>セットID</b></font></td> 
            <td width="200" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtID" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="01" Width="40px"></asp:TextBox> 
          ...
          <tr> 
            ...
            <td width="200" align="left" bgcolor="#FFE7DF"> 
              <asp:TextBox ID="txtCatalog" runat="server" onkeyup="document.getElementById('btnSearch').click();" onfocus="moveCursorLast(this);" MaxLength="14" Width="140px"></asp:TextBox> 
        ...
        <asp:UpdatePanel ID="udpList" runat="server" UpdateMode="Conditional" > 
          <ContentTemplate> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                <asp:BoundColumn  HeaderText="セットID" SortExpression="SET_ID" DataField="SET_ID" > 
                    <ItemStyle Width="70px" HorizontalAlign="Center" /> 
                    <HeaderStyle Width="70px" /> 
                </asp:BoundColumn> 
                <asp:BoundColumn HeaderText="セット名" SortExpression="SET_NAME" DataField="SET_NAME" > 
                ...
                <asp:TemplateColumn HeaderText="組番" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="40px" HeaderStyle-Width="40px"> 
                  <ItemTemplate> 
                    <asp:Label ID="lblKumi" runat="server" Text='<%# GetKumi(DataBinder.Eval(Container, "DataItem.CATALOG_NO"))%>' /> 
                  </ItemTemplate> 
                </asp:TemplateColumn> 
              </Columns> 
