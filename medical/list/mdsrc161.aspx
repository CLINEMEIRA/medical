<%@ Page Language="VB" AutoEventWireup="false" Inherits="medical.master_mdsrc161" Codebehind="mdsrc161.aspx.vb" %> 
...
<head runat="server"> 
  ...
  <script language="javascript" type="text/javascript"><!-- 
    function closeWindow(siji,syanai,tanaban) 
    { 
        parent.window.returnValue = siji + "," + syanai + "," + tanaban + ","; 
        parent.window.close(); 
    } 
    function closeWindow2(siji,jituzai) 
    { 
        parent.window.returnValue = siji + "," + jituzai + ","; 
        parent.window.close(); 
    } 
  // --></script> 
</head> 
        ...
        <table border="0" cellpadding="2" cellspacing="1"> 
          <tr height="20"> 
            ...
            <td width="330" align="left" bgcolor="#FFE7DF"> 
              <asp:Label ID="lblCatalog" runat="server" /> 
            ...
            <asp:DataGrid id="grdList" runat="server" AllowPaging="True" PageSize="15" BorderWidth="0px" BorderStyle="None" BorderColor="#FF4D04" CellPadding="2" CellSpacing="1" GridLines="Horizontal" AutoGenerateColumns="False" AllowSorting="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="MidnightBlue"> 
              ...
              <Columns> 
                ...
                <asp:TemplateColumn HeaderText="入庫日" SortExpression="WH_DT"> 
                  <ItemTemplate> 
                    <asp:Label ID="Label1" runat="server" Text='<%#MedicalLib.Common.DateFormat(DataBinder.Eval(Container, "DataItem.WH_DT"))%>'></asp:Label> 
                  </ItemTemplate> 
                ...
                <asp:BoundColumn  HeaderText="棚番" SortExpression="SHELF_NO" DataField="SHELF_NO" > 
