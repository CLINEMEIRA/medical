...
Partial Class master_mdsrc121 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC121" 
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                txtNo.Text = Request.QueryString("cyumon")
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            ...
            sQuery += "WHERE WH_END_FLG= '0' AND WH_END_DT = '00000000' AND TRIM(CANCEL_CD) IS NULL AND ORDER_DECIDE_KB = '1' AND "
            sQuery += "SUBSTR(MATL_CD,1,:K10) >= :K11 AND SUBSTR(ORDER_NO,1,:K20) >= :K21 "
