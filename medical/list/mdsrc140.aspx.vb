...
Partial Class master_mdsrc140 
    Inherits System.Web.UI.Page 
 
    Private Const PROGRAM_ID As String = "MDSRC140" 
    Private Const PROGRAM_TITLE As String = "製品グループ検索(L1)" 
...
#Region " 画面関連 "
    ...
    Private Sub DisplayList()
        ...
        Try
            sQuery = "SELECT GRP_NO,GRP_NM FROM PRODUCT_GRP_MST "
            sQuery += "WHERE GRP_LV = '1' AND GRP_NM LIKE :K01 ORDER BY GRP_NO"
